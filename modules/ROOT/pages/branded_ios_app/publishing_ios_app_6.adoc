...
To create this, return to Keychain Access on your Mac computer and find your private key that you created at the beginning (see xref:/branded_ios_app/publishing_ios_app_2[Create Certificate Signing Request]).
